...
<script src="./js/about-news-visual.js"></script>
...
<section class="about_news_visual">
  ...
  <div class="digits_text_container">
    <div class="digits_container type2">
      <ul class="digits1">
        <li>0</li>
        <li>2</li>
        <li>3</li>
  ...
  <!--digitstext_container-->

  <div class="indicator">
    <button class="prev" data-dir="prev"><i class="far fa-arrow-alt-circle-left"></i></button>
    <div class="progress">
      <span></span>
    </div>
    <button class="next" data-dir="next"><i class="far fa-arrow-alt-circle-right"></i></button>
    <p class="cnt type2"><sup>1</sup> / <sub>0</sub></p>
  </div><!-- indicator -->
</section>
<!--section-about-news-1 ---------------------------------------------------------------------- -->
<section class="section-about-news-1 section_category type4 light">
  <div class="center_14">
    <svg viewBox="0 0 941 936" preserveAspectRatio="xMidYMid slice">
      <path class="path" pathLength="1" fill="none" stroke="#000000" stroke-miterlimit="10" d="M521.501,0c0,116.998-102,116.998-102,233.996
           c0,116.997,102,116.997,102,233.994c0,117.002-102,117.002-102,234.005s102,117.003,102,234.005" />
    </svg>
    <h2 class="bold">2022 NEWS</h2>
    <ul class="clearfix">
      <li>
        <div class="inner">
          <figure>
...
<!--section-about-news-2 ---------------------------------------------------------------------- -->
<section class="section-about-news-2 section_category type3 dark">
  <div class="center_14">
    <svg viewBox="0 0 702 841" preserveAspectRatio="xMidYMid slice">
      <path class="path" pathLength="1" fill="none" stroke="white" stroke-miterlimit="10" d="M351.5,66.5V95H242c-35.2,0-64,28.8-64,64v108h338 v103c0,35.2-28.8,64-64,64H242c-35.2,0-64,28.8-64,64v98h338c0,0,0,21.15,0,47s-28.8,47-64,47h-41c-35.2,0-64,28.8-64,64v87" />
    </svg>
    <h2 class="bold">2021 NEWS<</h2>
