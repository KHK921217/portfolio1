...
<!--   <nav class="ydr-homme-nav">
    <div class="ydr-homme-name">
      <span class="ydr-button">
        <button data-n="1">DIOR HOMME COLOGNE</button>
        <button data-n="2">DIOR HOMME</button>
        <button data-n="3">DIOR HOMME INTENSE</button>
      </span>
    ...
    <img class="ydr-figure-img" src="./img/yoodareen/homme/3348901419147_2.jpg" alt="">
  </nav>
